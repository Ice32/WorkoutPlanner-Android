...
public class DoneWorkoutsListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.workouts_done_workouts_fragment_item_list, container, false);
        // Set the adapter
        if (view instanceof RecyclerView) {
            ...
            new ScheduledWorkoutsService().getDoneScheduledWorkouts(scheduledWorkouts -> recyclerView.setAdapter(new DoneWorkoutsViewAdapter(
                    scheduledWorkouts,
                    mListener
            )));
        }
